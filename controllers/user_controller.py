...
from models.user_model import create_user, find_user_by_email, verify_user, verify_user_by_token, mail, generate_new_verification_token, is_user_verified
...
def resend_verification_email():
    ...
    verification_token = generate_new_verification_token(data["email"])
    verification_url = url_for('verify_email', token=verification_token, _external=True)
